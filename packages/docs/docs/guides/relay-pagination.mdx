...
- See the [API reference](/api/graphql-mocks/modules/relay.html#relayWrapper)
...
### `paginateNodes`
* [API](/api/graphql-mocks/modules/relay.html#paginateNodes)
...
* [API](/api/graphql-mocks/modules/relay.html#isRelayConnectionField)
