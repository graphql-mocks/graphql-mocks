...
import { DataStore, Document, DocumentTypeValidator, FieldValidator } from '../types';
...
export function validate(
  ...
  combinedValidators.forEach((validator) => validator.validate({ data, graphqlSchema, document, type }));
}
